...
while True:
    ...
    for ball in list_of_balls:
        mother_ball.update()
        if(checkcollision(mother_ball,list_of_balls[0])==True):
            list_of_balls[0].velocity_x +=5
        if(checkcollision(mother_ball,list_of_balls[1])==True):
            list_of_balls[1].velocity_x +=5
        if(checkcollision(mother_ball,list_of_balls[2])==True):   
